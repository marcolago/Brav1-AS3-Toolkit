...
package com.brav1.loaders
{
	...
	public class BufferLoader extends EventDispatcher
	{
		 ...
		 * @return				ritorna un riferimento al LoaderInfo della risorsa in coda
		 */
		public function addFile(url:String, autoStart:Boolean = false, loadWhenIdle:Boolean = false):LoaderInfo
		{
		...
		private function add(url:String, autoStart:Boolean, loadWhenIdle:Boolean):LoaderInfo
		{
		...
		private function addToQueue(loaderInfo:LoaderInfo):void
		{
			dictLoader[loaderInfo].queued = true;
			removeFromWaitList(loaderInfo);
		}
		
		private function removeFromQueue(loaderInfo:LoaderInfo):void
		{
			dictLoader[loaderInfo].queued = false;
		}
		
		private function addToWaitList(loaderInfo:LoaderInfo):void
		{
			dictLoader[loaderInfo].wait = true;
			removeFromQueue(loaderInfo);
		}
		
		private function removeFromWaitList(loaderInfo:LoaderInfo):void
		{
		...
		private function load(loader:Loader, request:URLRequest):void
		{
		...
		/**
		 * Forza il caricamento della risorsa specificata nel LoaderInfo fermando tutti gli altri caricamenti
		 * @param	loaderInfo	il riferimento alla risorsa da caricare
		 */
		public function forceLoad(loaderInfo:LoaderInfo, resume:Boolean = true):void
		{
			for (var p:* in dictLoader)
			{
				if (p !== loaderInfo)
		 ...
		 */
		public function stopLoad(loaderInfo:LoaderInfo, resume:Boolean = true):void
		{
		...
		private function onIOError(e:IOErrorEvent):void 
		{
			if (_progressive == true)
			{
				dictLoader[e.target as LoaderInfo].loaded = false;
				removeFromQueue(e.target as LoaderInfo);
				removeFromWaitList(e.target as LoaderInfo);
			}
			else
			{
				for (var p:* in dictLoader)
		 ...
		 */
		public function isLoaded(loaderInfo:LoaderInfo):Boolean
		{
		 ...
		 */
		public function isQueued(loaderInfo:LoaderInfo):Boolean
		{
		 ...
		 */
		public function getContent(loaderInfo:LoaderInfo):Object
		{
		 ...
		 */
		public function getRequest(loaderInfo:LoaderInfo):URLRequest
		{
